...
-- 存储过程
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetLearningRecords` (IN `sessionUsername` VARCHAR(255))   BEGIN
    SELECT * FROM learning_record WHERE username = sessionUsername;
END$$
...
('25', 'aaa', '33', '6', '2023-06-14 17:55:04'),
('27', 'aaa', '0', '13', '2023-06-14 17:58:33'),
('28', 'aaa', '20', '10', '2023-06-14 18:00:24');
...
('aaa', '20', '2023-06-08 19:51:12', '2023-06-08 19:51:35'),
('aaa', '20', '2023-06-08 20:21:19', '2023-06-08 20:21:32'),
('aaa', '20', '2023-06-09 10:28:52', '2023-06-09 10:29:11'),
('aaa', '40', '2023-06-11 17:45:37', '2023-06-11 17:45:56'),
('aaa', '0', '2023-06-12 16:31:47', '2023-06-12 16:32:28'),
('aaa', '30', '2023-06-14 17:42:41', '2023-06-14 17:42:55'),
('aaa', '30', '2023-06-14 17:55:51', '2023-06-14 17:56:10');
...
INSERT INTO `news` (`username`, `role`, `title`, `content`, `time`) VALUES
('2107010118', 'admin', '公告', '公告', '2023-06-14 16:18:09'),
('aa', 'organizer', '组织员', '组织员', '2023-06-14 16:20:10'),
('aaa', 'user', 'gdsfg', 'sdgasd f', '2023-06-14 16:57:37');
...
('23', '1', '2023-06-07 19:08:00', '2023-06-09 19:08:00'),
('23', '2', '2023-06-07 19:08:00', '2023-06-09 19:08:00'),
('23', '3', '2023-06-07 19:08:00', '2023-06-09 19:08:00'),
('24', '1', '2023-06-08 22:40:00', '2023-06-10 22:40:00'),
('24', '2', '2023-06-08 22:40:00', '2023-06-10 22:40:00'),
('24', '3', '2023-06-08 22:40:00', '2023-06-10 22:40:00'),
('24', '17', '2023-06-08 22:40:00', '2023-06-10 22:40:00'),
('25', '1', '2023-06-14 17:35:00', '2023-06-16 17:35:00'),
('25', '2', '2023-06-14 17:35:00', '2023-06-16 17:35:00'),
('25', '3', '2023-06-14 17:35:00', '2023-06-16 17:35:00'),
('26', '21', '2023-06-14 17:57:00', '2023-06-14 17:57:00'),
('26', '22', '2023-06-14 17:57:00', '2023-06-14 17:57:00'),
('26', '23', '2023-06-14 17:57:00', '2023-06-14 17:57:00'),
('26', '24', '2023-06-14 17:57:00', '2023-06-14 17:57:00'),
('26', '25', '2023-06-14 17:57:00', '2023-06-14 17:57:00'),
('26', '26', '2023-06-14 17:57:00', '2023-06-14 17:57:00'),
('26', '27', '2023-06-14 17:57:00', '2023-06-14 17:57:00'),
('27', '22', '2023-06-14 17:58:00', '2023-06-17 17:58:00'),
('27', '23', '2023-06-14 17:58:00', '2023-06-17 17:58:00'),
('27', '24', '2023-06-14 17:58:00', '2023-06-17 17:58:00'),
('27', '25', '2023-06-14 17:58:00', '2023-06-17 17:58:00'),
('27', '26', '2023-06-14 17:58:00', '2023-06-17 17:58:00'),
('27', '27', '2023-06-14 17:58:00', '2023-06-17 17:58:00'),
('28', '16', '2023-06-14 17:59:00', '2023-06-24 18:00:00'),
('28', '17', '2023-06-14 17:59:00', '2023-06-24 18:00:00'),
('28', '18', '2023-06-14 17:59:00', '2023-06-24 18:00:00'),
('28', '19', '2023-06-14 17:59:00', '2023-06-24 18:00:00'),
('28', '22', '2023-06-14 17:59:00', '2023-06-24 18:00:00');
...
--
DELIMITER $$
CREATE TRIGGER `update_login_count` BEFORE INSERT ON `statistics` FOR EACH ROW BEGIN
    DECLARE login_count INT;

    -- 检查今天是否已存在登录和学习数据
    SELECT login INTO login_count
    FROM statistics
    WHERE time = NEW.time;

    IF login_count IS NOT NULL THEN
        -- 更新登录人数
        SET NEW.login = login_count + 1;
    END IF;
END
$$
DELIMITER ;
